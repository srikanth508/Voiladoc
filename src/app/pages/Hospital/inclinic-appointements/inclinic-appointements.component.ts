...
@Component({
  selector: 'app-inclinic-appointements',
  templateUrl: './inclinic-appointements.component.html',
  styleUrls: ['./inclinic-appointements.component.css']
})
export class InclinicAppointementsComponent implements OnInit {
