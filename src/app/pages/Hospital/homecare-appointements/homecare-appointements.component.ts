...
@Component({
  selector: 'app-homecare-appointements',
  templateUrl: './homecare-appointements.component.html',
  styleUrls: ['./homecare-appointements.component.css']
})
export class HomecareAppointementsComponent implements OnInit {
