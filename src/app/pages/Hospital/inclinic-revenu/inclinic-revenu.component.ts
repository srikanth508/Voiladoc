...
@Component({
  selector: 'app-inclinic-revenu',
  templateUrl: './inclinic-revenu.component.html',
  styleUrls: ['./inclinic-revenu.component.css']
})
export class InclinicRevenuComponent implements OnInit {
