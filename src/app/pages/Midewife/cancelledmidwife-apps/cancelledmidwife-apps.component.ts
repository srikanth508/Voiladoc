...
@Component({
  selector: 'app-cancelledmidwife-apps',
  templateUrl: './cancelledmidwife-apps.component.html',
  styleUrls: ['./cancelledmidwife-apps.component.css']
})
export class CancelledmidwifeAppsComponent implements OnInit {
