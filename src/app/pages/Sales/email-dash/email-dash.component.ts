...
@Component({
  selector: 'app-email-dash',
  templateUrl: './email-dash.component.html',
  styleUrls: ['./email-dash.component.css']
})
export class EmailDashComponent implements OnInit {
  ...
  public GetPatientlistEmailsList() {
    this.docservice.GetPatientEmails(this.languageid,this.startdate,this.enddate).subscribe(
      data => {
