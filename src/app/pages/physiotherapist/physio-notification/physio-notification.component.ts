...
@Component({
  selector: 'app-physio-notification',
  templateUrl: './physio-notification.component.html',
  styleUrls: ['./physio-notification.component.css']
})
export class PhysioNotificationComponent implements OnInit {
