...
@Component({
  selector: 'app-cancelled-physioappointments',
  templateUrl: './cancelled-physioappointments.component.html',
  styleUrls: ['./cancelled-physioappointments.component.css']
})
export class CancelledPhysioappointmentsComponent implements OnInit {
