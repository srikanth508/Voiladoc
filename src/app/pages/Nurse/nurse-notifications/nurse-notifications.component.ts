...
@Component({
  ...
  styleUrls: ['./nurse-notifications.component.css']
})
export class NurseNotificationsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.docservice.GetNotifications_NPMWeb(this.nurseid, this.startdate, this.enddate, 25,this.languageid).subscribe(
      data => {
