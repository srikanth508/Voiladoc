...
@Component({
  selector: 'app-dia-completed-tickets',
  templateUrl: './dia-completed-tickets.component.html',
  styleUrls: ['./dia-completed-tickets.component.css']
})
export class DiaCompletedTicketsComponent implements OnInit {
