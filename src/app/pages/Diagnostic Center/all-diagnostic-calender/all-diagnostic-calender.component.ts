...
@Component({
  selector: 'app-all-diagnostic-calender',
  templateUrl: './all-diagnostic-calender.component.html',
  styleUrls: ['./all-diagnostic-calender.component.css']
})
export class AllDiagnosticCalenderComponent implements OnInit {
