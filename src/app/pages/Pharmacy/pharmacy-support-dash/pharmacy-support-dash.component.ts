...
@Component({
  selector: 'app-pharmacy-support-dash',
  templateUrl: './pharmacy-support-dash.component.html',
  styleUrls: ['./pharmacy-support-dash.component.css']
})
export class PharmacySupportDashComponent implements OnInit {
