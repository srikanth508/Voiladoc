...
@Component({
  selector: 'app-pha-patient-chat',
  templateUrl: './pha-patient-chat.component.html',
  styleUrls: ['./pha-patient-chat.component.css']
})
export class PhaPatientChatComponent implements OnInit {
