...
@Component({
  selector: 'app-pharmacy-completed-tickets',
  templateUrl: './pharmacy-completed-tickets.component.html',
  styleUrls: ['./pharmacy-completed-tickets.component.css']
})
export class PharmacyCompletedTicketsComponent implements OnInit {
